...
import '../data/tourist_sites_data.dart';
import '../widgets/map/custom_market.dart';
import '../widgets/map/map_control.dart';
import '../widgets/map/map_stas_overlay.dart';
import '../widgets/map/site_details_mdal.dart';
...
class _MapScreenState extends State<MapScreen> {
  ...
  List<Marker> _buildMarkers(GameProgressProvider gameProgress) {
    return _getFilteredSites().map((site) {
      final isVisited = gameProgress.isPlaceVisited(site['id']);
            ...
            children: [
              ...
              FlutterMap(
                ...
                children: [
                  ...
                  MarkerLayer(
                    markers: _buildMarkers(gameProgress),
                  ),
                ],
              ),
              ...
              Positioned(
                ...
                child: MapStatsOverlay(
                  ...
                  visitedSites: gameProgress.placesVisitedCount,
